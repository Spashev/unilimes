...
COPY ./nginx-configs/fastcgi_params /etc/nginx/
COPY ./nginx-configs/mime.types /etc/nginx/
COPY ./php-config/php.ini /usr/local/etc/php/conf.d/upload.ini
COPY ./php-config/php.ini /etc/php8/conf.d/upload.ini
